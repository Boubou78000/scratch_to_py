...
BLOCKS = {
    ...
    # Motion
    "motion_movesteps": ("move_steps({})", ["STEPS"]),
    "motion_turnright": ("turn_right({})", ["DEGREES"]),
    "motion_turnleft": ("turn_left({})", ["DEGREES"]),
    "motion_goto": ("go_to_sprite({})", ["TO"]),
    "motion_gotoxy": ("set_x_y_to({},{})", ["X", "Y"]),
    "motion_glideto": ("glide_secs_to_sprite({},{})", ["SECS","TO"]),
    "motion_glidesecstoxy": ("glide_secs_to_x_y()", ["SECS", "X", "Y"]),
    "motion_pointindirection": ("point_in_direction({})", ["DIRECTION"]),
    "motion_pointtowards": ("point_towards_sprite({})", ["TOWARDS"]),
    "motion_changexby": ("change_x_by({})", ["DX"]),
    "motion_setx": ("set_x_to({})", ["X"]),
    "motion_changeyby": ("change y by {}", ["DY"]),
    "motion_sety": ("set_y_to({})", ["Y"]),
    ...
    "looks_switchcostumeto": ("switch_costume_to({})", ["COSTUME"]),
    "looks_nextcostume": ("next_costume", []),
    "looks_switchbackdropto": ("switch_backdrop to {}", ["BACKDROP"]),
    "looks_nextbackdrop": ("next_backdrop", []),
    "looks_changesizeby": ("change_size_by{}", ["CHANGE"]),
    "looks_setsizeto": ("set_size_to{} %", ["SIZE"]),
